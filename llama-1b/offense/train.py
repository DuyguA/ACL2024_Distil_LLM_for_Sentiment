...
tweets_df = pd.read_csv("test.csv", delimiter="\t")  # Assuming tab-separated file
print("Tweets file preview:")
print(tweets_df.head())

# Load the second file (labels)
labels_df = pd.read_csv("labels.csv", delimiter=",")  # Assuming no header
print("\nLabels file preview:")
...
id2label = {0: "NEU", 1: "OFF"}

label2id = {"NEU": 0, "OFF": 1}
...
trainer.save_model("llama-1b-offense")
...
test_df.to_csv("test_predictions_llama_offense.csv", index=False)
